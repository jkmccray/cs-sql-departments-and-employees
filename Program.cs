...
namespace DepartmentsEmployees
{
    class Program
    {
        ...
        public static void PrintDepartmentReport(string title, List<Department> departments)
        {
            ...
            {
                Console.WriteLine($"{counter++}. {dept.DeptName}");
            }
            Console.ReadLine();
        }
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            if (title == "All Employees")
            {
                ...
                {
                    Console.WriteLine($"{counter++}. {e.FirstName} {e.LastName}");
                }
            }
            else
            {
                ...
                foreach (Employee e in employees)
                {
                    Console.WriteLine($"{counter++}. {e.FirstName} {e.LastName}. Dept: {e.Department.DeptName}");
                }
            }
